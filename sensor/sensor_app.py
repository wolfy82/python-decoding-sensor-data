...
print("\nHouse Temperature records for date: {} : {}".format(
...
print("House Humidity sensor for date: {} = {}".format(test_date.strftime("%m/%d/%y"), len(recs)))
print("\tAverage: {} humidity".format(mean(recs)))
